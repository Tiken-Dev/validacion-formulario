// Utilizar expresiones regulares para validar formularios de manera correcta:
...
function eventListeners() {
    ...
    //Blur valida el formulario cuando el usuario pasa del primer input al contenedor del Formulario:
...
function enviarEmail(e) {
    ...
    setTimeout( () => {
        ...
        setTimeout( () => {
            parrafo.remove(); //Elimina el mensaje de éxito después de 5 segundos.
            resetearFormulario();
        }, 5000);
...
// Elimina el color verde de los inputs al resetear el Formulario:
